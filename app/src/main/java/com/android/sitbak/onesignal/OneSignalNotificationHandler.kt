...
import com.android.sitbak.utils.NotificationTypes.DriverAcceptDelivery
import com.android.sitbak.utils.NotificationTypes.MessageReceivedFromDriver
    ...
    override fun notificationOpened(result: OSNotificationOpenResult) {
        ...
        try {
            ...
            if (SharedPreference.getBoolean(baseApplication, Constants.isUserLoggedIn)) {
                ...
                val intent = Intent(baseApplication, BoardingActivity::class.java)
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
                baseApplication.startActivity(intent)
            }
        } catch (e: Exception) {
